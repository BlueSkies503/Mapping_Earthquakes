...
// based on its magnitude. Earthquakes with a magnitude of 0
// will be plotted with a radius of 1.
...
// Creating a GeoJSON layer with the retrieved data.
  L.geoJSON(data, {
      ...
      // We set the style for each circleMarker using our
      // styleInfo function.
     style: styleInfo,
     // We create a popup for each circleMarker ta display
    ...
    legend.onAdd = function(map) {
      ...
      // Looping through our intervals to generate a label
